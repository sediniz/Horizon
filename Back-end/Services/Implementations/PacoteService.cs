...
{
    public class PacoteService : IPacote
    {
        private readonly Repositories.Interface.IService<Pacote> _repository;

        public PacoteService(Repositories.Interface.IService<Pacote> repository)
        {
        ...
        public async Task<IEnumerable<Pacote>> GetByDestinoAsync(string destino)
        {
            ...
            var pacotes = await _repository.GetAllAsync();
